...
for index, puzzle in enumerate(puzzles):
    print '# Test', (index + 1)
    run_search('Depth-first search', puzzle, tree_search, puzzle, DepthFirstSearchFringe())
    run_search('Breadth-first search', puzzle, tree_search, puzzle, BreadthFirstSearchFringe())
    run_search('Depth-limited search', puzzle, depth_limited_search, puzzle, 5)
    run_search('Iterative deepening search', puzzle, iterative_deepening_search, puzzle)
    print ''